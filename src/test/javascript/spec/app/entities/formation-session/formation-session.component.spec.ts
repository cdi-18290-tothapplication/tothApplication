...
import { FormationSessionComponent } from 'app/entities/formation-session/formation-session.component';
...
describe('Component Tests', () => {
  describe('FormationSession Management Component', () => {
    let comp: FormationSessionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FormationSessionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.formationSessions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
