...
import { StudientComponent } from 'app/entities/studient/studient.component';
...
describe('Component Tests', () => {
  describe('Studient Management Component', () => {
    let comp: StudientComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StudientComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.studients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
